// lib/adminPermissions.js — Tra quyền của 1 tài khoản api-admin/: có vai trò
...
// có "thấy trang hay không"). Cache trong bộ nhớ TTL ngắn (không nhúng vào
// JWT — xem lib/adminAuth.js) để đổi nhóm quyền có hiệu lực gần như ngay,
