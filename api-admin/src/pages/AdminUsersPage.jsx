// pages/AdminUsersPage.jsx — Trang "Tài khoản quản trị": CRUD admin.AdminUsers
// + gán nhóm quyền (admin.AdminUserRoles, xem pages/RolesPage.jsx) — thay
// mô hình TRƯỚC ĐÂY (chỉ xem danh sách + "Đặt lại 2FA", tạo/sửa tài khoản
// phải chạy tay scripts/seedAdmin.js). canEdit('users') cho thao tác tài
// khoản THÔNG THƯỜNG (tạo/sửa/khoá/đặt lại mật khẩu); gán vai trò + đặt lại
// 2FA CHẶT hơn — chỉ isSystemRole thật mới thấy nút (server cũng chặn qua
// requireSystemRoleActor, xem api-server/routes/admin/users.js).
...
export default function AdminUsersPage() {
  ...
  // (xem api-server/routes/admin/users.js).
  ...
  return (
    <div className="page">
      ...
      {canManage && <p className="hint">Tài khoản mới chưa thấy trang nào — vào "Vai trò" hoặc bấm "Gán vai trò" bên dưới để cấp quyền.</p>}
