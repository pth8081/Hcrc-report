...
// (kèm cờ CanEdit — xem etl/routes/admin/roles.js). Vai trò hệ thống (admin)
// không sửa/xoá được — server đã chặn, ở đây chỉ ẩn nút cho gọn. Đơn giản
// hơn RolesPage.jsx bên rp-user (chỉ 1 lớp quyền menu, không có report/
// domain access).
