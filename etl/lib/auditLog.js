...
// tác" trên etl-admin/) — khác etl.SyncLog (log CHẠY JOB tự động, xem
// jobs/runSync.js). Lỗi khi ghi log KHÔNG được làm hỏng request gốc — luôn
// nuốt lỗi, chỉ log ra console để không biến một thao tác nghiệp vụ thành
// công thành lỗi 500 chỉ vì ghi nhật ký thất bại. Cùng khuôn với
// rp-server/lib/auditLog.js, chỉ khác đọc req.admin (JWT payload etl-admin —
// xem lib/adminAuth.js) thay vì req.user.
