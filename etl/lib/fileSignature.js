...
// (xem lib/dataSourcesImport.js, lib/salesTargetsImport.js) — MAX_IMPORT_ROWS
// ở 2 file đó chỉ chặn ĐƯỢC sau khi ExcelJS đã giải nén + parse xong, quá
// trễ để chặn bom nén.
//
...
// trong header mỗi entry, không phải số liệu tự suy luận.
