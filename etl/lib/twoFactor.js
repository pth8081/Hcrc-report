...
// etl-admin/ — BẮT BUỘC khi Role='admin' (xem routes/admin/twoFactor.js +
// routes/admin/auth.js). Secret mã hoá bằng lib/crypto.js (ETL_ENCRYPTION_KEY),
