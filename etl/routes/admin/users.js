// routes/admin/users.js — Trang "Phân quyền": CRUD admin.AdminUsers + gán
// nhóm quyền (admin.AdminUserRoles, xem routes/admin/roles.js) — thay mô
// hình 3 Role cố định cũ. requireMenuEdit('users') cho các thao tác tài
// khoản THÔNG THƯỜNG (tạo/sửa/khoá/đặt lại mật khẩu — CÓ THỂ giao cho 1 tài
// khoản không phải vai trò hệ thống, vd 1 người chỉ quản lý tài khoản);
// requireSystemRoleActor CHẶT hơn cho thao tác NHẠY CẢM (gán vai trò, đặt
// lại 2FA) — chặn đường leo thang: 1 tài khoản chỉ có menu 'users' có thể
// tự tạo vai trò hệ thống rồi gán cho chính mình nếu không chặn riêng (mirror
...
// không còn quyết định quyền (xem etl-db/schema.sql).
